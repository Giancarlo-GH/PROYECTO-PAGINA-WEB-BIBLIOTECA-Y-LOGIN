...
<table width="90%" align="center" class="TablaMod">
    ...
    <tr>
        <td align="center"><input class="texto" type="text" name="cod" size="10" /></td>
        ...
        <td align="center"><input class="texto" type="text" name="Descripcion" size="45" /></td>
        <td align="center"><input class="texto" type="text" name="RefEnlace" size="26" /></td>
        <td align="center"><select  name="Escuela">
...
if(isset($_POST['Modificar'])){
    ...
    $esc=$_POST['Escuela'];
    $sql = "update tesis set titulot = '$tit', refimgt= '$ref', autort= '$autor', desct= '$desc', refent= '$refen', escuela= '$esc' where idt = '$id'"; 
    $cont = "select count(*) from tesis where idt = '$id'";
